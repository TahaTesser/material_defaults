...
const String materialLib = '../lib/src/material';
...
Future<void> main(List<String> args) async {
  ...
  ButtonTemplate('md.comp.filled-tonal-button', 'FilledTonalButton', '$materialLib/filled_button_tonal.dart', tokens).updateFile();
  ...
  CardTemplate('md.comp.elevated-card', 'Card', '$materialLib/card_elevated.dart', tokens).updateFile();
  CardTemplate('md.comp.filled-card', 'FilledCard', '$materialLib/card_filled.dart', tokens).updateFile();
  CardTemplate('md.comp.outlined-card', 'OutlinedCard', '$materialLib/card_outlined.dart', tokens).updateFile();
  ...
  DialogFullscreenTemplate('DialogFullscreen', '$materialLib/dialog_fullscreen.dart', tokens).updateFile();
  ...
  IconButtonTemplate('md.comp.filled-icon-button', 'FilledIconButton', '$materialLib/icon_button_filled.dart', tokens).updateFile();
  IconButtonTemplate('md.comp.filled-tonal-icon-button', 'FilledTonalIconButton', '$materialLib/icon_button_filled_tonal.dart', tokens).updateFile();
  IconButtonTemplate('md.comp.outlined-icon-button', 'OutlinedIconButton', '$materialLib/icon_button_outlined.dart', tokens).updateFile();

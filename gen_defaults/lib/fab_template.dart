...
class ${blockName}DefaultsM3 extends FloatingActionButtonThemeData {
  ${blockName}DefaultsM3(this.context, this.type, this.hasChild)
    : super(
  ...
  ShapeBorder? get shape {
    return switch (type) {
      FloatingActionButtonType.regular  => ${shape("md.comp.fab.primary.container")},
      FloatingActionButtonType.small    => ${shape("md.comp.fab.primary.small.container")},
      FloatingActionButtonType.large    => ${shape("md.comp.fab.primary.large.container")},
      FloatingActionButtonType.extended => ${shape("md.comp.extended-fab.primary.container")},
    };
  }
  ...
  double? get iconSize {
    return switch (type) {
      FloatingActionButtonType.regular  => ${getToken("md.comp.fab.primary.icon.size")},
      FloatingActionButtonType.small    => ${getToken("md.comp.fab.primary.small.icon.size")},
      FloatingActionButtonType.large    => ${getToken("md.comp.fab.primary.large.icon.size")},
      FloatingActionButtonType.extended => ${getToken("md.comp.extended-fab.primary.icon.size")},
    };
  }

...
class ${blockName}DefaultsM3 extends DialogThemeData {
  ${blockName}DefaultsM3(this.context)
    : super(
...
class ${blockName}DefaultsM3 extends DialogThemeData {
  const ${blockName}DefaultsM3(this.context): super(clipBehavior: Clip.none);

...
class ${blockName}PrimaryDefaultsM3 extends TabBarThemeData {
  ${blockName}PrimaryDefaultsM3(this.context, this.isScrollable)
...
class ${blockName}SecondaryDefaultsM3 extends TabBarThemeData {
  ${blockName}SecondaryDefaultsM3(this.context, this.isScrollable)
